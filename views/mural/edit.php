...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Editar Item do Mural</h4>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  name="descricao" 
                                  rows="5" 
                                  placeholder="Descrição do evento ou aviso..."><?php echo e($mural->descricao); ?></textarea>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="data_inicio" 
                                       name="data_inicio"
                                       value="<?php echo $mural->data_inicio ? date('Y-m-d', strtotime($mural->data_inicio)) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="data_fim" 
                                       name="data_fim"
                                       value="<?php echo $mural->data_fim ? date('Y-m-d', strtotime($mural->data_fim)) : ''; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="url" 
                                       ...
                                       id="link_url" 
                                       name="link_url" 
                                       value="<?php echo e($mural->link_url); ?>"
                                       placeholder="https://...">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="link_texto" 
                                       name="link_texto" 
                                       value="<?php echo e($mural->link_texto); ?>"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch mt-4">
                                    ...
                                    <input class="form-check-input" 
                                           ...
                                           name="is_ativo" 
                                           value="1"
                                           <?php echo $mural->is_ativo ? 'checked' : ''; ?>>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <?php if ($mural->imagem_url): ?>
                            <div class="mt-3">
                                <p class="text-muted mb-2">Imagem Atual:</p>
                                <img src="<?php echo e($mural->imagem_url); ?>" 
                                     alt="Imagem atual" 
...
document.getElementById('mural-form').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo url('/mural/' . $mural->id); ?>', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        if (data.success) {
            alert('Item do mural atualizado com sucesso!');

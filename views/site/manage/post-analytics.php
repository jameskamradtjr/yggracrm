...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Analytics do Post</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Analytics: <?php echo e($post->title); ?></li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0">Post: <?php echo e($post->title); ?></h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Tipo:</strong> <?php echo ucfirst($post->type); ?></p>
                        ...
                        <div class="col-md-6">
                            <p><strong>Data de Publicação:</strong> <?php echo $post->published_at ? date('d/m/Y H:i', strtotime($post->published_at)) : 'Não publicado'; ?></p>
                            <p><strong>Visualizações:</strong> <?php echo $post->views_count ?? 0; ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (daysFilter) {
        daysFilter.addEventListener("change", function() {
            ...
            window.location.href = "' . url('/site/manage/posts/' . $post->id . '/analytics') . '?days=" + days;
        });
    }

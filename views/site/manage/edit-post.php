            ...
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Editar Post</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="type" name="type" required>
                                    <option value="text" <?php echo $post->type === 'text' ? 'selected' : ''; ?>>Texto</option>
                                    <option value="youtube" <?php echo $post->type === 'youtube' ? 'selected' : ''; ?>>Vídeo YouTube</option>
                                    <option value="twitter" <?php echo $post->type === 'twitter' ? 'selected' : ''; ?>>Tweet Twitter</option>
                                </select>
                            </div>
                            
                            <div class="mb-3" id="externalUrlContainer" style="display: <?php echo in_array($post->type, ['youtube', 'twitter']) ? 'block' : 'none'; ?>;">
                                <label for="external_url" class="form-label">URL Externa</label>
                                <input type="url" 
                                       class="form-control" 
                                       id="external_url" 
                                       name="external_url" 
                                       value="<?php echo e($post->external_url ?? ''); ?>">

        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="card-title fw-semibold mb-2">Editar Usuário</h4>
                        <p class="card-subtitle mb-0">Atualize as informações do usuário</p>
                    </div>
                ...
                <form action="<?php echo url('/users/' . $user->id); ?>" method="POST" id="formEditUser">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="dados" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active" <?php echo (old('status', $user->status) === 'active') ? 'selected' : ''; ?>>Ativo</option>
                                        <option value="inactive" <?php echo (old('status', $user->status) === 'inactive') ? 'selected' : ''; ?>>Inativo</option>
                                        <option value="suspended" <?php echo (old('status', $user->status) === 'suspended') ? 'selected' : ''; ?>>Suspenso</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="password" class="form-label">Nova Senha <span class="text-muted">(deixe em branco para manter a atual)</span></label>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="row">
                                                    <?php foreach ($acoes as $acaoKey => $acaoNome): ?>
                                                        ...
                                                        $permKey = "{$moduloKey}.{$recursoKey}.{$acaoKey}";
                                                        $checked = isset($userPermissions[$permKey]) && $userPermissions[$permKey] ? 'checked' : '';
                                                        ?>

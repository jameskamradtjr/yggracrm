...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Editar Projeto</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Editar Projeto</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo url('/projects/' . $project->id); ?>">
            <input type="hidden" name="_csrf_token" value="<?php echo csrf_token(); ?>">
            
            <div class="row">
                <div class="col-md-12 mb-3">
                    <label for="titulo" class="form-label">Título do Projeto <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo e($project->titulo); ?>" required>
                </div>
                
                <div class="col-md-12 mb-3">
                    <label for="descricao" class="form-label">Descrição</label>
                    <textarea class="form-control" id="descricao" name="descricao" rows="4" placeholder="Descreva o projeto..."><?php echo e($project->descricao ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="status" name="status" required>
                        <option value="planejamento" <?php echo $project->status === 'planejamento' ? 'selected' : ''; ?>>Planejamento</option>
                        <option value="em_andamento" <?php echo $project->status === 'em_andamento' ? 'selected' : ''; ?>>Em Andamento</option>
                        <option value="pausado" <?php echo $project->status === 'pausado' ? 'selected' : ''; ?>>Pausado</option>
                        <option value="concluido" <?php echo $project->status === 'concluido' ? 'selected' : ''; ?>>Concluído</option>
                        <option value="cancelado" <?php echo $project->status === 'cancelado' ? 'selected' : ''; ?>>Cancelado</option>
                    </select>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="prioridade" name="prioridade" required>
                        <option value="baixa" <?php echo $project->prioridade === 'baixa' ? 'selected' : ''; ?>>Baixa</option>
                        <option value="media" <?php echo $project->prioridade === 'media' ? 'selected' : ''; ?>>Média</option>
                        <option value="alta" <?php echo $project->prioridade === 'alta' ? 'selected' : ''; ?>>Alta</option>
                        <option value="urgente" <?php echo $project->prioridade === 'urgente' ? 'selected' : ''; ?>>Urgente</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" class="form-control" id="data_inicio" name="data_inicio" value="<?php echo $project->data_inicio ? date('Y-m-d', strtotime($project->data_inicio)) : ''; ?>">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="data_termino_prevista" class="form-label">Data de Término Prevista</label>
                    <input type="date" class="form-control" id="data_termino_prevista" name="data_termino_prevista" value="<?php echo $project->data_termino_prevista ? date('Y-m-d', strtotime($project->data_termino_prevista)) : ''; ?>">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="data_termino_real" class="form-label">Data de Término Real</label>
                    <input type="date" class="form-control" id="data_termino_real" name="data_termino_real" value="<?php echo $project->data_termino_real ? date('Y-m-d', strtotime($project->data_termino_real)) : ''; ?>">
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="lead_id" name="lead_id">
                        ...
                        <?php foreach ($leads as $lead): ?>
                            <option value="<?php echo $lead->id; ?>" <?php echo $project->lead_id == $lead->id ? 'selected' : ''; ?>>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="responsible_user_id" name="responsible_user_id">
                        ...
                        <?php foreach ($users as $user): ?>
                            <option value="<?php echo $user->id; ?>" <?php echo $project->responsible_user_id == $user->id ? 'selected' : ''; ?>>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="progresso" name="progresso" min="0" max="100" value="<?php echo $project->progresso ?? 0; ?>">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="orcamento" name="orcamento" min="0" value="<?php echo $project->orcamento ?? ''; ?>" placeholder="0.00">
                </div>
                
                <div class="col-md-6 mb-3">
                    <label for="custo_real" class="form-label">Custo Real (R$)</label>
                    <input type="number" step="0.01" class="form-control" id="custo_real" name="custo_real" min="0" value="<?php echo $project->custo_real ?? ''; ?>" placeholder="0.00">
                </div>
            </div>

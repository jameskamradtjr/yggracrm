...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Editar Conhecimento</h4>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo url('/knowledge-base/' . $knowledge->id . '/update'); ?>" id="knowledgeForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="titulo" 
                               name="titulo" 
                               value="<?php echo e($knowledge->titulo); ?>" 
                               required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" 
                                  id="resumo" 
                                  name="resumo" 
                                  rows="3"><?php echo e($knowledge->resumo ?? ''); ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" 
                                  id="conteudo" 
                                  name="conteudo" 
                                  rows="15"><?php echo e($knowledge->conteudo); ?></textarea>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="categoria" 
                                       name="categoria" 
                                       value="<?php echo e($knowledge->categoria ?? ''); ?>">
                            </div>
                            
                            <div class="mb-3">
                                <label for="status" class="form-label">Status</label>
                                <select class="form-select" id="status" name="status">
                                    <option value="rascunho" <?php echo $knowledge->status === 'rascunho' ? 'selected' : ''; ?>>Rascunho</option>
                                    <option value="publicado" <?php echo $knowledge->status === 'publicado' ? 'selected' : ''; ?>>Publicado</option>
                                    <option value="arquivado" <?php echo $knowledge->status === 'arquivado' ? 'selected' : ''; ?>>Arquivado</option>
                                </select>
                            </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="d-flex justify-content-end gap-2">
                        <a href="<?php echo url('/knowledge-base/' . $knowledge->id); ?>" class="btn btn-light">
                            Cancelar
                        </a>
...
<script>
// Tags management
let tags = <?php echo json_encode(explode(', ', $tagsInput)); ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('knowledgeForm').addEventListener('submit', function(e) {
        ...
        // Atualiza campo tags_input com as tags
        const tagsInput = document.getElementById('tags-input');
        if (tagsInput) {

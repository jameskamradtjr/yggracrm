...
<div class="row">
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo url('/contracts/templates/' . $template->id); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="conteudo" name="conteudo" rows="20" required><?php echo e($template->conteudo); ?></textarea>

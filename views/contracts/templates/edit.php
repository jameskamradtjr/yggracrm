...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Editar Template</h4>
...
<div class="row">
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo url('/contracts/templates/' . $template->id); ?>" id="templateForm">
                    <?php echo csrf_field(); ?>
                    
                    <div class="mb-3">
                        <label for="nome" class="form-label">Nome do Template <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nome" name="nome" value="<?php echo e($template->nome); ?>" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="conteudo" class="form-label">Conteúdo do Template <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="conteudo" name="conteudo" rows="20"><?php echo e($template->conteudo); ?></textarea>
                        <small class="text-muted">Use variáveis como {{nome_cliente}}, {{documento_cliente}}, etc.</small>
                    </div>
                    
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="ativo" name="ativo" value="1" <?php echo $template->ativo ? 'checked' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="observacoes" name="observacoes" rows="3"><?php echo e($template->observacoes ?? ''); ?></textarea>
                    </div>

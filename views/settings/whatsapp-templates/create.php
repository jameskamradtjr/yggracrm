<?php
$title = 'Criar Template de WhatsApp';
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="card-title fw-semibold mb-2">Criar Template de WhatsApp</h4>
                        <p class="card-subtitle mb-0">Crie um novo template para envio de mensagens WhatsApp</p>
                    </div>
                ...
                <form action="<?php echo url('/settings/whatsapp-templates'); ?>" method="POST">
                    <?php echo csrf_field(); ?>

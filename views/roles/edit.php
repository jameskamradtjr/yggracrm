        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="card-title fw-semibold mb-2">Editar Role</h4>
                        <p class="card-subtitle mb-0">Atualize as informações e permissões da role</p>
                    </div>
                ...
                <form action="<?php echo url('/roles/' . $role->id); ?>" method="POST" id="roleForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" value="<?php echo e($role->slug); ?>" disabled>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" required><?php echo e(old('description', $role->description)); ?></textarea>
                    </div>

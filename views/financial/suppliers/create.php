    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo url('/financial/suppliers'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="is_client" class="form-check-input" id="is_client" value="1">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="receives_invoice" class="form-check-input" id="receives_invoice" value="1">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="issues_invoice" class="form-check-input" id="issues_invoice" value="1">

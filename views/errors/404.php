    ...
    <div class="container-fluid">
        <div class="row vh-100 align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
                ...
                <h1 class="fw-bold mb-3"><?php echo e($title ?? 'Página Não Encontrada'); ?></h1>
                <p class="text-muted mb-4"><?php echo e($message ?? 'A página que você está procurando não existe ou foi removida.'); ?></p>
